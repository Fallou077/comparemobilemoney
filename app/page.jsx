  ...
  const items = [
    {
      ...
      color: C.blue,
      light: "#E8F4FF",
      title: "Mettre à jour les tarifs régulièrement",
      urgency: "Hebdomadaire",
      content: `Les opérateurs changent leurs tarifs sans prévenir. Voici votre routine :

📅 CHAQUE SEMAINE :
• Vérifiez les sites officiels : wave.com/fr, orange.sn/money, free.sn/free-money
• Comparez avec les données dans votre fichier page.jsx (section OPERATORS)
• Mettez à jour les tableaux de frais si nécessaire

📅 CHAQUE MOIS :
• Vérifiez les limites journalières et mensuelles
• Contrôlez les frais des services internationaux (Sendwave, WorldRemit)
• Publiez un article de blog "Tarifs Mobile Money — [Mois] [Année]"

🔧 COMMENT MODIFIER LES TARIFS :
Dans page.jsx, section OPERATORS, modifiez les tableaux fees.send, fees.withdraw.
Exemple pour Wave : fees.send passe de 0 à 100 → changer "send: 0" en "send: 100"`,
    },
    {
      icon: "🔍",
      color: C.green,
      light: "#E8FFF1",
      title: "Stratégie SEO — attirer du trafic depuis Google",
      urgency: "En continu",
      content: `Le SEO est votre moteur de revenus. Voici le plan concret :

📝 ARTICLES À PUBLIER EN PRIORITÉ (les + cherchés) :
• "Frais Wave 2026 — tout ce qu'il faut savoir"
• "Comment convertir Wave en Orange Money gratuitement"
• "Sendwave vers Sénégal : guide complet 2026"
• "Orange Money vs Wave : lequel choisir en 2026 ?"
• "Comment envoyer de l'argent de France au Sénégal"

📌 RÈGLES SEO À RESPECTER :
• 1 mot-clé principal par article (ex : "frais Wave Sénégal")
• Minimum 800 mots par article
• Balise title : "[Mot-clé] — CompareMobileMoney"
• Balise meta description : 155 caractères max, incluez le mot-clé
• Images avec alt text descriptif
• Liens internes entre vos articles

📈 OUTILS GRATUITS :
• Google Search Console → vérifiez vos positions
• Google Analytics → suivez votre trafic
• Ubersuggest (gratuit) → trouvez de nouveaux mots-clés`,
    },
    {
      icon: "💰",
      color: "#F59E0B",
      light: "#FFFBEB",
      title: "Monétisation — activer Google AdSense",
      urgency: "Dès 100 visites/jour",
      content: `AdSense est votre source de revenus principale. Étapes concrètes :

✅ PRÉREQUIS POUR L'APPROBATION ADSENSE :
• Minimum 20 articles de blog publiés
• Site en ligne depuis au moins 3–6 mois
• Mentions légales + politique de confidentialité présentes
• Pas de contenu copié

🚀 COMMENT POSTULER :
1. Allez sur adsense.google.com
2. Ajoutez votre site et collez le code de vérification dans votre layout.jsx
3. Attendez 2–4 semaines pour l'approbation
4. Une fois approuvé, intégrez les blocs pub dans votre page

📍 MEILLEURS EMPLACEMENTS PUB :
• Après le calculateur (zone la plus vue)
• Entre les sections du comparateur
• Sidebar droite (sur desktop)
• En bas de chaque article de blog

💡 AUTRES REVENUS :
• Affiliation Sendwave : sendwave.com/affiliates
• Affiliation WorldRemit : cherchez "WorldRemit affiliate program"
• Articles sponsorisés : 20 000–80 000 FCFA par article payé par un opérateur`,
    },
    {
      icon: "🚀",
      color: C.purple,
      light: "#F5F3FF",
      title: "Mise en ligne — déployer sur Vercel",
      urgency: "Étapes techniques",
      content: `Déploiement complet en moins d'une heure, gratuitement.

📦 ÉTAPE 1 — Préparer le projet Next.js :
npx create-next-app@latest comparemobilemoney --typescript --tailwind
cd comparemobilemoney
→ Remplacez app/page.tsx par votre page.jsx (renommez en page.tsx)

🔗 ÉTAPE 2 — Pousser sur GitHub :
git init
git add .
git commit -m "Premier commit"
git remote add origin https://github.com/VOTRE_USER/comparemobilemoney.git
git push -u origin main

🌐 ÉTAPE 3 — Déployer sur Vercel :
1. Allez sur vercel.com → "New Project"
2. Importez votre repo GitHub
3. Cliquez "Deploy" → votre site est en ligne en 2 minutes !
URL gratuite : comparemobilemoney.vercel.app

🌍 ÉTAPE 4 — Nom de domaine personnalisé :
• Achetez comparemobilemoney.com (~12$/an sur Namecheap)
• Dans Vercel → Settings → Domains → ajoutez votre domaine
• Configurez les DNS chez Namecheap comme indiqué par Vercel

📧 ÉTAPE 5 — Emails (alertes tarifs) :
• Créez un compte Resend.com (100 emails/jour gratuits)
• Intégrez l'API Resend pour envoyer les alertes automatiquement`,
    },
    {
      icon: "📈",
      color: C.teal,
      light: "#F0FDFA",
      title: "Croissance — obtenir les 1 000 premiers visiteurs",
      urgency: "Mois 1–3",
      content: `Plan d'action concret pour décoller rapidement.

🎯 SEMAINE 1 — Lancement :
• Partagez le lien dans 10 groupes WhatsApp (argent, tech, entrepreneurs)
• Postez sur LinkedIn avec un angle : "J'ai créé le premier comparateur Mobile Money Africa"
• Publiez sur les groupes Facebook : "Sénégalais en France", "Entrepreneurs Dakar"

📱 SEMAINE 2–4 — Réseaux sociaux :
• Créez un compte TikTok/Instagram : publiez des conseils ("Saviez-vous que Wave est gratuit pour envoyer ?")
• Chaque vidéo redirige vers le site
• Rejoignez des communautés Reddit : r/Senegal, r/WestAfrica, r/afrocurrency

🔗 MOIS 2 — Backlinks (liens entrants) :
• Contactez des blogueurs finance africains pour des partenariats
• Proposez votre comparateur comme ressource aux journalistes qui couvrent la fintech africaine
• Soumettez le site sur Product Hunt

📊 OBJECTIFS PAR ÉTAPE :
• Mois 1 : 500 visiteurs → pas d'AdSense encore
• Mois 3 : 3 000 visiteurs → AdSense activable
• Mois 6 : 15 000 visiteurs → premiers revenus significatifs
• Mois 12 : 80 000+ visiteurs → 400–2000 $/mois`,
    },
    {
      icon: "🛡️",
      color: C.red,
      light: "#FFF5F5",
      title: "Mentions légales & conformité (obligatoire)",
      urgency: "Avant la mise en ligne",
      content: `Ne mettez pas le site en ligne sans ces éléments légaux.

📋 PAGES OBLIGATOIRES À CRÉER :
1. Mentions légales (éditeur du site, hébergeur, coordonnées)
2. Politique de confidentialité (collecte des emails, cookies, Google Analytics)
3. CGU (conditions générales d'utilisation)

⚠️ DISCLAIMER IMPORTANT :
Ajoutez sur toutes les pages : "Les tarifs affichés sont fournis à titre indicatif. Vérifiez toujours les conditions officielles auprès des opérateurs avant toute transaction."

🍪 BANDEAU COOKIES (pour les visiteurs européens) :
Si vous utilisez Google Analytics, vous DEVEZ afficher un bandeau de consentement cookies. Utilisez la librairie gratuite : cookie-consent-js

📊 EXACTITUDE DES DONNÉES :
• Indiquez la date de dernière mise à jour des tarifs
• Ne garantissez jamais l'exactitude à 100% (les opérateurs changent sans prévenir)
• Proposez un formulaire "Signaler une erreur" pour garder les données propres`,
    },
  ];

  return (
    <section id="gestion" className="section-pad" style={{ background: C.bg, padding: "64px 24px" }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        <SectionHeader
          eyebrow="⚙️ Guide de gestion"
          title="Comment gérer et faire croître ce site ?"
          subtitle="Tout ce qu'il faut savoir pour maintenir, monétiser et développer CompareMobileMoney"
        />

        <div className="gestion-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 14, marginBottom: 20 }}>
          {items.map((item, i) => (
            <div key={i}>
              <div onClick={() => setOpenItem(openItem === i ? null : i)} style={{ background: "#fff", borderRadius: 14, padding: "18px 20px", border: openItem === i ? `2px solid ${item.color}` : `1px solid ${C.border}`, cursor: "pointer", transition: "all .2s" }}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                  <div style={{ width: 40, height: 40, borderRadius: 10, background: item.light, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, flexShrink: 0 }}>{item.icon}</div>
                  <div style={{ flex: 1 }}>
                    <div style={{ fontWeight: 600, fontSize: 13, color: C.dark, lineHeight: 1.4, marginBottom: 6 }}>{item.title}</div>
                    <span style={{ background: item.light, color: item.color, borderRadius: 6, padding: "2px 8px", fontSize: 10, fontWeight: 700 }}>{item.urgency}</span>
                  </div>
                  <span style={{ color: C.muted, fontSize: 18, transition: "transform .2s", transform: openItem === i ? "rotate(45deg)" : "none" }}>+</span>
                </div>
                ...
                {openItem === i && (
                  <div style={{ marginTop: 16, paddingTop: 16, borderTop: `1px solid ${C.border}` }}>
                    {item.content.split("\n").map((line, j) => {
                      ...
                      const isBold = line.startsWith("📅") || line.startsWith("📝") || line.startsWith("📌") || line.startsWith("📈") || line.startsWith("✅") || line.startsWith("🚀") || line.startsWith("🔗") || line.startsWith("🌍") || line.startsWith("📧") || line.startsWith("🎯") || line.startsWith("📱") || line.startsWith("📊") || line.startsWith("📋") || line.startsWith("⚠️") || line.startsWith("🍪") || line.startsWith("📦") || line.startsWith("💡") || line.startsWith("📍");
                      const isCode = line.trim().startsWith("npx") || line.trim().startsWith("git") || line.trim().startsWith("cd ");
                      if (isCode) return <div key={j} style={{ background: C.dark, color: "#00C853", borderRadius: 6, padding: "6px 12px", fontFamily: "monospace", fontSize: 12, marginBottom: 4 }}>{line.trim()}</div>;
                      return <div key={j} style={{ fontSize: 13, color: isBold ? C.dark : "#4A5568", fontWeight: isBold ? 700 : 400, lineHeight: 1.7, marginBottom: 2 }}>{line}</div>;
                    })}
                  </div>
                )}
              </div>
        ...
        {/* Timeline */}
        <div style={{ background: "#fff", borderRadius: 20, padding: "28px", border: `1px solid ${C.border}` }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: C.dark, marginBottom: 20 }}>📅 Planning de lancement — 8 semaines</div>
          <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
            {[
              { week: "Sem. 1", tasks: "Créer le projet Next.js · Intégrer le code · Tester en local", color: C.blue },
              { week: "Sem. 2", tasks: "Mettre en ligne sur Vercel · Acheter le domaine · Google Search Console", color: C.purple },
              { week: "Sem. 3–4", tasks: "Écrire 10 articles SEO · Mentions légales · Partager sur WhatsApp & Facebook", color: C.green },
              { week: "Sem. 5–6", tasks: "Créer TikTok/Instagram · 2 vidéos/semaine · Atteindre 500 visiteurs", color: C.orange },
              { week: "Sem. 7–8", tasks: "Postuler AdSense · Contacter services internationaux pour affiliation · Viser 3 000 visiteurs", color: C.teal },
            ].map((item, i) => (
              <div key={i} style={{ display: "flex", gap: 16, paddingBottom: i < 4 ? 20 : 0 }}>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                  <div style={{ width: 36, height: 36, borderRadius: "50%", background: item.color, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700, flexShrink: 0 }}>{i + 1}</div>
                  {i < 4 && <div style={{ width: 2, flex: 1, minHeight: 20, background: C.border }} />}
                </div>
                <div style={{ paddingTop: 6, paddingBottom: i < 4 ? 12 : 0 }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: item.color, marginBottom: 4 }}>{item.week}</div>
                  <div style={{ fontSize: 13, color: "#4A5568", lineHeight: 1.65 }}>{item.tasks}</div>
                </div>
              </div>
            ))}
          </div>
